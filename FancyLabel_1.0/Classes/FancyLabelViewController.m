...
- (void)loadView {
	...
	[self.tweetLabel setText:@"This is a #test of regular expressions #hashtag http://www.google.com with http://example.com links as used in @Twitterrific. HTTP://CHOCKLOCK.COM APPROVED OF COURSE."];
	...
	switchButton.titleLabel.font = [UIFont boldSystemFontOfSize:16.0f];
